 ...
 */
package dubbo.provider.bootstrap;

import dubbo.provider.service.DefaultDemoService;
...
public class DubboAutoConfigurationProviderBootstrap {
    ...
    public static void main(String[] args) {
        // new SpringApplicationBuilder(DubboAutoConfigurationProviderBootstrap.class).run(args);
