 ...
 * 可以自定义一些Handler，Interceptor，ViewResolver，MessageConverter。基于java-based方式的spring
 * mvc配置， 需要创建一个配置类并实现WebMvcConfigurer 接口
 * 方式1：实现org.springframework.web.servlet.config.annotation.WebMvcConfigurer
 * 方式2：继承org.springframework.web.servlet.config.annotation.WebMvcConfigurationSupport
 */
@Configuration
@ConditionalOnMissingBean(WebMvcConfigurationSupport.class)
public class WebMvcConfiguration implements EnvironmentAware, WebMvcConfigurer {
