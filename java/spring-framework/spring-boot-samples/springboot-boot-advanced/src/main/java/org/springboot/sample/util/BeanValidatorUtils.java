...
public class BeanValidatorUtils {
    ...
    extractMessage(Set<? extends ConstraintViolation> constraintViolations) {
        List<
                String> errorMessages = new ArrayList<String>();
    ...
    extractPropertyAndMessage(ConstraintViolationException e) {
    ...
    extractPropertyAndMessage(Set<? extends ConstraintViolation> constraintViolations) {
        Map<
                String, String> errorMessages = new HashMap<String, String>();
        for (ConstraintViolation violation : constraintViolations) {
    ...
    extractPropertyAndMessageAsList(ConstraintViolationException e, String separator) {
