...
public class MyParameterizedType implements ParameterizedType {
    ...
    private void validateConstructorArguments() {
        ...
        if (typeVariables.length != this.actualTypeArguments.length) {
    ...
    public static MyParameterizedType make(Class<?> var0, Type[] var1, Type var2) {
        return new MyParameterizedType(var0, var1, var2);
    }
    ...
    public String toString() {
        ...
        if (this.ownerType != null) {
            ...
            var1.append("$");
            if (this.ownerType instanceof MyParameterizedType) {
                var1.append(this.rawType.getName().replace(((MyParameterizedType) this.ownerType).rawType.getName() + "$", ""));
            } else {
