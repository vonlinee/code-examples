package code.example.thirdlib.javapoet;
...
class HowToJavaPoetDemo {
	...
	public static FieldSpec parameterizedTypeField() {
		...
		return FieldSpec
				.builder(ParameterizedTypeName.get(List.class, String.class), "mParameterizedField", Modifier.PRIVATE)
				.build();
	}
	...
	public static FieldSpec wildcardTypeField() {
		...
		return FieldSpec
				.builder(ParameterizedTypeName.get(ClassName.get(List.class), WildcardTypeName.subtypeOf(String.class)),
						"mWildcardField", Modifier.PRIVATE)
				.build();
	}
