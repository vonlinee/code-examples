package org.example.springboot.config.properties;
 ...
 */
@Component
@ConfigurationProperties(prefix = "spring.datasource") // spring.datasource是springboot内置提供的
public class DruidProperties {

	private static final String DB_NAME = "mysql_learn";

	// 通过代码配置，而不是配置文件，要求spring.datasource拼上属性名是spring已经定义好的配置名
