...
class CellUtils {
    ...
    static <T> JFXTextField createJFXTextField(final Cell<T> cell, final StringConverter<T> converter) {
        final JFXTextField textField = new JFXTextField(getItemText(cell, converter));
