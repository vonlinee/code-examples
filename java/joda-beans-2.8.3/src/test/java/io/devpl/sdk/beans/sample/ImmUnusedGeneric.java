...
public final class ImmUnusedGeneric<T> implements ImmutableBean {
    ...
    public String toString() {
        String buf = "ImmUnusedGeneric{" +
                "errorMessage" + '=' + JodaBeanUtils.toString(errorMessage) +
                '}';
        return buf;
    }
    ...
    public static final class Meta<T> extends DirectMetaBean {
        ...
        protected MetaProperty<?> metaPropertyGet(String propertyName) {
            if (propertyName.hashCode() == 1203236063) {  // errorMessage
                return errorMessage;
            }
    ...
    static final class Builder<T> extends DirectFieldsBeanBuilder<ImmUnusedGeneric<T>> {
        ...
        @Override
        public String toString() {
            String buf = "ImmUnusedGeneric.Builder{" +
                    "errorMessage" + '=' + JodaBeanUtils.toString(errorMessage) +
                    '}';
            return buf;
        }
