...
import io.devpl.sdk.beans.sample.Company;
import io.devpl.sdk.beans.sample.CompanyAddress;
import io.devpl.sdk.beans.sample.INamedKey;
import io.devpl.sdk.beans.sample.ImmAddress;
import io.devpl.sdk.beans.sample.ImmGeneric;
import io.devpl.sdk.beans.sample.ImmGenericArray;
import io.devpl.sdk.beans.sample.ImmGenericCollections;
import io.devpl.sdk.beans.sample.ImmGuava;
import io.devpl.sdk.beans.sample.ImmJodaConvertBean;
import io.devpl.sdk.beans.sample.ImmJodaConvertWrapper;
import io.devpl.sdk.beans.sample.ImmKey;
import io.devpl.sdk.beans.sample.ImmKeyHolder;
import io.devpl.sdk.beans.sample.ImmKeyList;
import io.devpl.sdk.beans.sample.ImmNamedKey;
...
import io.devpl.sdk.beans.sample.RiskLevel;
import io.devpl.sdk.beans.sample.RiskPerception;
...
public class SerTestHelper {
    ...
    public static ImmAddress testImmAddress() {
        ...
        map3.put("A", Collections.singletonList(Arrays.asList(3, 2, 1)));
        ...
        List<Object> objects1 = Arrays.asList(Currency.getInstance("GBP"), TimeZone.getTimeZone("Europe/London"));
        List<Object> objects2 = Arrays.asList(Locale.CANADA_FRENCH, Long.valueOf(2), primitives);
        map5.put("A", Collections.singletonList(objects1));
        map5.put("B", Collections.singletonList(objects2));
        ...
        ImmPerson person = ImmPerson.builder()
            ...
            .middleNames("K", "T")
            .surname("Colebourne")
            .addressList(Collections.singletonList(new Address()))
