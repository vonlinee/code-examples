...
public final class ImmOptional implements ImmutableBean {
    ...
    public String toString() {
        String buf = "ImmOptional{" +
                "optString" + '=' + JodaBeanUtils.toString(optString) + ',' + ' ' +
                "optStringEmpty" + '=' + JodaBeanUtils.toString(optStringEmpty) + ',' + ' ' +
                "optStringGetter" + '=' + JodaBeanUtils.toString(optStringGetter) + ',' + ' ' +
                "optLongGetter" + '=' + JodaBeanUtils.toString(optLongGetter) + ',' + ' ' +
                "optIntGetter" + '=' + JodaBeanUtils.toString(optIntGetter) + ',' + ' ' +
                "optDoubleGetter" + '=' + JodaBeanUtils.toString(optDoubleGetter) + ',' + ' ' +
                "twelve" + '=' + JodaBeanUtils.toString(getTwelve()) +
                '}';
        return buf;
    }
    ...
    public static final class Builder extends DirectFieldsBeanBuilder<ImmOptional> {
        ...
        @Override
        public String toString() {
            String buf = "ImmOptional.Builder{" +
                    "optString" + '=' + JodaBeanUtils.toString(optString) + ',' + ' ' +
                    "optStringEmpty" + '=' + JodaBeanUtils.toString(optStringEmpty) + ',' + ' ' +
                    "optStringGetter" + '=' + JodaBeanUtils.toString(optStringGetter) + ',' + ' ' +
                    "optLongGetter" + '=' + JodaBeanUtils.toString(optLongGetter) + ',' + ' ' +
                    "optIntGetter" + '=' + JodaBeanUtils.toString(optIntGetter) + ',' + ' ' +
                    "optDoubleGetter" + '=' + JodaBeanUtils.toString(optDoubleGetter) + ',' + ' ' +
                    "twelve" + '=' + JodaBeanUtils.toString(null) +
                    '}';
            return buf;
        }
