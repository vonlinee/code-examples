...
public final class PropertyDefBean implements Bean {
    ...
    public String toString() {
        String buf = "PropertyDefBean{" +
                "stringAsCharSequence" + '=' + JodaBeanUtils.toString(getStringAsCharSequence()) + ',' + ' ' +
                "intAsInteger" + '=' + JodaBeanUtils.toString(getIntAsInteger()) + ',' + ' ' +
                "listCopyOfCollection" + '=' + JodaBeanUtils.toString(getListCopyOfCollection()) + ',' + ' ' +
                "arrayListSmart" + '=' + JodaBeanUtils.toString(getArrayListSmart()) + ',' + ' ' +
                "arrayListExposed" + '=' + JodaBeanUtils.toString(getArrayListExposed()) + ',' + ' ' +
                "arrayListAsCollection" + '=' + JodaBeanUtils.toString(getArrayListAsCollection()) + ',' + ' ' +
                "arrayList" + '=' + JodaBeanUtils.toString(getArrayList()) + ',' + ' ' +
                "listAsIterable" + '=' + JodaBeanUtils.toString(getListAsIterable()) + ',' + ' ' +
                "listAsIterableNoField" + '=' + JodaBeanUtils.toString(getListAsIterableNoField()) +
                '}';
        return buf;
    }
