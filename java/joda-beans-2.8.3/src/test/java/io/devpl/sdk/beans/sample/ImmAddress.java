...
public final class ImmAddress implements ImmutableBean, Serializable {
    ...
    public String toString() {
        String buf = "ImmAddress{" +
                "number" + '=' + JodaBeanUtils.toString(number) + ',' + ' ' +
                "street" + '=' + JodaBeanUtils.toString(street) + ',' + ' ' +
                "city" + '=' + JodaBeanUtils.toString(city) + ',' + ' ' +
                "abstractNumber" + '=' + JodaBeanUtils.toString(abstractNumber) + ',' + ' ' +
                "data" + '=' + JodaBeanUtils.toString(data) + ',' + ' ' +
                "array2d" + '=' + JodaBeanUtils.toString(array2d) + ',' + ' ' +
                "owner" + '=' + JodaBeanUtils.toString(owner) + ',' + ' ' +
                "object1" + '=' + JodaBeanUtils.toString(object1) + ',' + ' ' +
                "object2" + '=' + JodaBeanUtils.toString(object2) + ',' + ' ' +
                "risk" + '=' + JodaBeanUtils.toString(risk) + ',' + ' ' +
                "riskLevel" + '=' + JodaBeanUtils.toString(riskLevel) + ',' + ' ' +
                "riskLevels" + '=' + JodaBeanUtils.toString(riskLevels) + ',' + ' ' +
                "serializable" + '=' + JodaBeanUtils.toString(serializable) + ',' + ' ' +
                "objectInMap" + '=' + JodaBeanUtils.toString(objectInMap) + ',' + ' ' +
                "listInMap" + '=' + JodaBeanUtils.toString(listInMap) + ',' + ' ' +
                "listNumericInMap" + '=' + JodaBeanUtils.toString(listNumericInMap) + ',' + ' ' +
                "listInListInMap" + '=' + JodaBeanUtils.toString(listInListInMap) + ',' + ' ' +
                "objectListInListInMap" + '=' + JodaBeanUtils.toString(objectListInListInMap) + ',' + ' ' +
                "mapInMap" + '=' + JodaBeanUtils.toString(mapInMap) + ',' + ' ' +
                "simpleTable" + '=' + JodaBeanUtils.toString(simpleTable) + ',' + ' ' +
                "compoundTable" + '=' + JodaBeanUtils.toString(compoundTable) + ',' + ' ' +
                "sparseGrid" + '=' + JodaBeanUtils.toString(sparseGrid) + ',' + ' ' +
                "denseGrid" + '=' + JodaBeanUtils.toString(denseGrid) + ',' + ' ' +
                "beanBeanMap" + '=' + JodaBeanUtils.toString(beanBeanMap) + ',' + ' ' +
                "doubleVector" + '=' + JodaBeanUtils.toString(doubleVector) + ',' + ' ' +
                "matrix" + '=' + JodaBeanUtils.toString(matrix) +
                '}';
        return buf;
    }
        ...
        public Builder set(String propertyName, Object newValue) {
            switch (propertyName.hashCode()) {
                ...
                case 106164915:  // owner
                    ...
                    break;
                case -1659648814:  // object1
                    this.object1 = newValue;
                    break;
                case -1659648813:  // object2
                    this.object2 = newValue;
                    break;
                case 3500751:  // risk
