...
public final class ImmTreeNode implements ImmutableBean {
    ...
    public String toString() {
        String buf = "ImmTreeNode{" +
                "name" + '=' + JodaBeanUtils.toString(name) + ',' + ' ' +
                "child1" + '=' + JodaBeanUtils.toString(getChild1()) + ',' + ' ' +
                "child2" + '=' + JodaBeanUtils.toString(child2) + ',' + ' ' +
                "child3" + '=' + JodaBeanUtils.toString(getChild3()) +
                '}';
        return buf;
    }
    ...
    public static final class Builder extends DirectFieldsBeanBuilder<ImmTreeNode> {
        ...
        @Override
        public String toString() {
            String buf = "ImmTreeNode.Builder{" +
                    "name" + '=' + JodaBeanUtils.toString(name) + ',' + ' ' +
                    "child1" + '=' + JodaBeanUtils.toString(child1) + ',' + ' ' +
                    "child2" + '=' + JodaBeanUtils.toString(child2) + ',' + ' ' +
                    "child3" + '=' + JodaBeanUtils.toString(child3) +
                    '}';
            return buf;
        }
