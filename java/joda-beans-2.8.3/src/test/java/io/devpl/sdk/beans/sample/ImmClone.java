...
public final class ImmClone implements ImmutableBean, Serializable{
    ...
    public String[] getArray2Nullable() {
        return (array2Nullable != null ? array2Nullable.clone() : null);
    }
    ...
    public String toString() {
        String buf = "ImmClone{" +
                "date" + '=' + JodaBeanUtils.toString(date) + ',' + ' ' +
                "array1" + '=' + JodaBeanUtils.toString(array1) + ',' + ' ' +
                "array2" + '=' + JodaBeanUtils.toString(array2) + ',' + ' ' +
                "array3" + '=' + JodaBeanUtils.toString(array3) + ',' + ' ' +
                "dateNullable" + '=' + JodaBeanUtils.toString(dateNullable) + ',' + ' ' +
                "array1Nullable" + '=' + JodaBeanUtils.toString(array1Nullable) + ',' + ' ' +
                "array2Nullable" + '=' + JodaBeanUtils.toString(array2Nullable) + ',' + ' ' +
                "array3Nullable" + '=' + JodaBeanUtils.toString(array3Nullable) +
                '}';
        return buf;
    }
