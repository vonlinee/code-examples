...
//    private final LinkedHashMultimap<T, String> setMultimapLinkedHash;
    ...
    public String toString() {
        String buf = "ImmGuava{" +
                "collection" + '=' + JodaBeanUtils.toString(collection) + ',' + ' ' +
                "list" + '=' + JodaBeanUtils.toString(list) + ',' + ' ' +
                "set" + '=' + JodaBeanUtils.toString(set) + ',' + ' ' +
                "sortedSet" + '=' + JodaBeanUtils.toString(sortedSet) + ',' + ' ' +
                "map" + '=' + JodaBeanUtils.toString(map) + ',' + ' ' +
                "sortedMap" + '=' + JodaBeanUtils.toString(sortedMap) + ',' + ' ' +
                "biMap" + '=' + JodaBeanUtils.toString(biMap) + ',' + ' ' +
                "multimap" + '=' + JodaBeanUtils.toString(multimap) + ',' + ' ' +
                "listMultimap" + '=' + JodaBeanUtils.toString(listMultimap) + ',' + ' ' +
                "setMultimap" + '=' + JodaBeanUtils.toString(setMultimap) + ',' + ' ' +
                "multiset" + '=' + JodaBeanUtils.toString(multiset) + ',' + ' ' +
                "sortedMultiset" + '=' + JodaBeanUtils.toString(sortedMultiset) + ',' + ' ' +
                "collectionInterface" + '=' + JodaBeanUtils.toString(collectionInterface) + ',' + ' ' +
                "listInterface" + '=' + JodaBeanUtils.toString(listInterface) + ',' + ' ' +
                "setInterface" + '=' + JodaBeanUtils.toString(setInterface) + ',' + ' ' +
                "sortedSetInterface" + '=' + JodaBeanUtils.toString(sortedSetInterface) + ',' + ' ' +
                "mapInterface" + '=' + JodaBeanUtils.toString(mapInterface) + ',' + ' ' +
                "sortedMapInterface" + '=' + JodaBeanUtils.toString(sortedMapInterface) + ',' + ' ' +
                "biMapInterface" + '=' + JodaBeanUtils.toString(biMapInterface) + ',' + ' ' +
                "multimapInterface" + '=' + JodaBeanUtils.toString(multimapInterface) + ',' + ' ' +
                "listMultimapInterface" + '=' + JodaBeanUtils.toString(listMultimapInterface) + ',' + ' ' +
                "setMultimapInterface" + '=' + JodaBeanUtils.toString(setMultimapInterface) + ',' + ' ' +
                "multisetInterface" + '=' + JodaBeanUtils.toString(multisetInterface) + ',' + ' ' +
                "sortedMultisetInterface" + '=' + JodaBeanUtils.toString(sortedMultisetInterface) + ',' + ' ' +
                "listWildExtendsT" + '=' + JodaBeanUtils.toString(listWildExtendsT) + ',' + ' ' +
                "listWildExtendsNumber" + '=' + JodaBeanUtils.toString(listWildExtendsNumber) + ',' + ' ' +
                "listWildExtendsComparable" + '=' + JodaBeanUtils.toString(listWildExtendsComparable) + ',' + ' ' +
                "setWildExtendsT" + '=' + JodaBeanUtils.toString(setWildExtendsT) + ',' + ' ' +
                "setWildExtendsNumber" + '=' + JodaBeanUtils.toString(setWildExtendsNumber) + ',' + ' ' +
                "setWildExtendsComparable" + '=' + JodaBeanUtils.toString(setWildExtendsComparable) + ',' + ' ' +
                "listWildBuilder1" + '=' + JodaBeanUtils.toString(listWildBuilder1) + ',' + ' ' +
                "listWildBuilder2" + '=' + JodaBeanUtils.toString(listWildBuilder2) + ',' + ' ' +
                "mapWildBuilder1" + '=' + JodaBeanUtils.toString(mapWildBuilder1) + ',' + ' ' +
                "mapWildKey" + '=' + JodaBeanUtils.toString(mapWildKey) +
                '}';
        return buf;
    }
