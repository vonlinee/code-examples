...
public final class ImmTypes<T extends Comparable<T>> implements ImmutableBean {
    ...
    public String toString() {
        String buf = "ImmTypes{" +
                "listWild" + '=' + JodaBeanUtils.toString(listWild) + ',' + ' ' +
                "listWildPublic1" + '=' + JodaBeanUtils.toString(listWildPublic1) + ',' + ' ' +
                "listWildPublic2" + '=' + JodaBeanUtils.toString(listWildPublic2) + ',' + ' ' +
