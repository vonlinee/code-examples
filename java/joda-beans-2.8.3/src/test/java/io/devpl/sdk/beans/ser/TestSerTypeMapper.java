...
public class TestSerTypeMapper {
    ...
    private static final JodaBeanSerializer SETTINGS = JodaBeanSerializer.PRETTY;
    private static final JodaBeanSerializer SETTINGS_NO_SHORT = JodaBeanSerializer.PRETTY.withShortTypes(false);
    ...
    public void test_encodeType() {
        ...
        assertFalse(cache.containsKey(File.class));
        // user type
        ...
        assertEquals(SerTypeMapper.encodeType(io.devpl.sdk.beans.ser.AtomicReference.class, SETTINGS, "java.util.", cache), "org.joda.beans.ser.AtomicReference");
        assertEquals(cache.get(io.devpl.sdk.beans.ser.AtomicReference.class), "org.joda.beans.ser.AtomicReference");
        // user type
