...
public final class MutableDeprecated implements Cloneable, Bean {
    ...
    public String toString() {
        String buf = "MutableDeprecated{" +
                "deprecatedBoth" + '=' + JodaBeanUtils.toString(getDeprecatedBoth()) + ',' + ' ' +
                "deprecatedJavadoc" + '=' + JodaBeanUtils.toString(getDeprecatedJavadoc()) + ',' + ' ' +
                "deprecatedAnnotation" + '=' + JodaBeanUtils.toString(getDeprecatedAnnotation()) + ',' + ' ' +
