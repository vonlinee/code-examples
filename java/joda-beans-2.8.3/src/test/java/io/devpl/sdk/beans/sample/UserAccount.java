...
public final class UserAccount implements Bean {
    ...
    public String toString() {
        String buf = "UserAccount{" +
                "userId" + '=' + JodaBeanUtils.toString(getUserId()) + ',' + ' ' +
                "emailAddress" + '=' + JodaBeanUtils.toString(getEmailAddress()) + ',' + ' ' +
                "numberLogins" + '=' + JodaBeanUtils.toString(getNumberLogins()) + ',' + ' ' +
                "lastLogin" + '=' + JodaBeanUtils.toString(getLastLogin()) +
                '}';
        return buf;
    }
