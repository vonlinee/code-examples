...
import io.devpl.sdk.beans.gen.ImmutableDefaults;
...
public final class ImmPerson implements ImmutableBean {
    ...
    public String toString() {
        String buf = "ImmPerson{" +
                "forename" + '=' + JodaBeanUtils.toString(forename) + ',' + ' ' +
                "surname" + '=' + JodaBeanUtils.toString(surname) + ',' + ' ' +
                "numberOfCars" + '=' + JodaBeanUtils.toString(numberOfCars) + ',' + ' ' +
                "dateOfBirth" + '=' + JodaBeanUtils.toString(dateOfBirth) + ',' + ' ' +
                "middleNames" + '=' + JodaBeanUtils.toString(middleNames) + ',' + ' ' +
                "addressList" + '=' + JodaBeanUtils.toString(addressList) + ',' + ' ' +
                "otherAddressMap" + '=' + JodaBeanUtils.toString(otherAddressMap) + ',' + ' ' +
                "addressesList" + '=' + JodaBeanUtils.toString(addressesList) + ',' + ' ' +
                "mainAddress" + '=' + JodaBeanUtils.toString(mainAddress) + ',' + ' ' +
                "codeCounts" + '=' + JodaBeanUtils.toString(codeCounts) + ',' + ' ' +
                "age" + '=' + JodaBeanUtils.toString(getAge()) +
                '}';
        return buf;
    }
    ...
    public static final class Builder extends DirectFieldsBeanBuilder<ImmPerson> {
        ...
        public String toString() {
            String buf = "ImmPerson.Builder{" +
                    ...
                    "mainAddress" + '=' + JodaBeanUtils.toString(mainAddress) + ',' + ' ' +
                    "codeCounts" + '=' + JodaBeanUtils.toString(codeCounts) + ',' + ' ' +
                    "age" + '=' + JodaBeanUtils.toString(null) +
                    '}';
            return buf;
        }
