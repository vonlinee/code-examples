...
import io.devpl.sdk.beans.sample.MutableDerivedBean;
...
public class TestMutableDerived {
    ...
    public void test_mutableDerivedBean() {
        ...
        Assert.assertEquals(test.metaBean().baseBeanString().get(test), "HopeNotHate");

        test.metaBean().baseBeanString().set(test, "Now");
        assertEquals(test.getBaseBeanString(), "Now");
        Assert.assertEquals(test.metaBean().baseBeanString().get(test), "Now");

        test.metaBean().baseBeanString().setString(test, "Please");
        assertEquals(test.getBaseBeanString(), "Please");
        Assert.assertEquals(test.metaBean().baseBeanString().get(test), "Please");
    }
