...
public final class SimpleJson implements ImmutableBean, Serializable {
    ...
    public String toString() {
        String buf = "SimpleJson{" +
                "primitiveChar" + '=' + JodaBeanUtils.toString(primitiveChar) + ',' + ' ' +
                "primitiveByte" + '=' + JodaBeanUtils.toString(primitiveByte) + ',' + ' ' +
                "primitiveShort" + '=' + JodaBeanUtils.toString(primitiveShort) + ',' + ' ' +
                "primitiveInt" + '=' + JodaBeanUtils.toString(primitiveInt) + ',' + ' ' +
                "primitiveLong" + '=' + JodaBeanUtils.toString(primitiveLong) + ',' + ' ' +
                "primitiveFloat" + '=' + JodaBeanUtils.toString(primitiveFloat) + ',' + ' ' +
                "primitiveDouble" + '=' + JodaBeanUtils.toString(primitiveDouble) + ',' + ' ' +
                "primitiveDoubleNaN" + '=' + JodaBeanUtils.toString(primitiveDoubleNaN) + ',' + ' ' +
                "primitiveDoubleInf" + '=' + JodaBeanUtils.toString(primitiveDoubleInf) + ',' + ' ' +
                "abstractNumber" + '=' + JodaBeanUtils.toString(abstractNumber) + ',' + ' ' +
                "arrayByte" + '=' + JodaBeanUtils.toString(arrayByte) + ',' + ' ' +
                "array2d" + '=' + JodaBeanUtils.toString(array2d) + ',' + ' ' +
                "string" + '=' + JodaBeanUtils.toString(string) + ',' + ' ' +
                ...
                "stringList" + '=' + JodaBeanUtils.toString(stringList) + ',' + ' ' +
                "beanList" + '=' + JodaBeanUtils.toString(beanList) + ',' + ' ' +
                "stringMap" + '=' + JodaBeanUtils.toString(stringMap) + ',' + ' ' +
                "intKeyMap" + '=' + JodaBeanUtils.toString(intKeyMap) + ',' + ' ' +
                "beanMap" + '=' + JodaBeanUtils.toString(beanMap) + ',' + ' ' +
