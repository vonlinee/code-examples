...
public final class ImmDeprecated implements Cloneable, ImmutableBean {
    ...
    public String toString() {
        String buf = "ImmDeprecated{" +
                "deprecatedBoth" + '=' + JodaBeanUtils.toString(deprecatedBoth) + ',' + ' ' +
                "deprecatedJavadoc" + '=' + JodaBeanUtils.toString(deprecatedJavadoc) + ',' + ' ' +
                "deprecatedAnnotation" + '=' + JodaBeanUtils.toString(deprecatedAnnotation) + ',' + ' ' +
                "deprecatedOptional" + '=' + JodaBeanUtils.toString(deprecatedOptional) +
                '}';
        return buf;
    }
    ...
    public static final class Builder extends DirectFieldsBeanBuilder<ImmDeprecated> {
        ...
        @Override
        public String toString() {
            String buf = "ImmDeprecated.Builder{" +
                    "deprecatedBoth" + '=' + JodaBeanUtils.toString(deprecatedBoth) + ',' + ' ' +
                    "deprecatedJavadoc" + '=' + JodaBeanUtils.toString(deprecatedJavadoc) + ',' + ' ' +
                    "deprecatedAnnotation" + '=' + JodaBeanUtils.toString(deprecatedAnnotation) + ',' + ' ' +
                    "deprecatedOptional" + '=' + JodaBeanUtils.toString(deprecatedOptional) +
