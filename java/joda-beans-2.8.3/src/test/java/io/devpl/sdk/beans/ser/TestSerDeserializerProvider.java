...
public class TestSerDeserializerProvider {
    ...
    public void test_classpathImmKey() {
        ...
        Assert.assertEquals(ImmKey.meta().name(), SerDeserializers.INSTANCE.findDeserializer(
    ...
    public void test_classpathPair() {
        ...
        Assert.assertEquals(Pair.meta().first(), SerDeserializers.INSTANCE.findDeserializer(
