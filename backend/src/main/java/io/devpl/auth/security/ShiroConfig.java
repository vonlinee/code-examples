...
public class ShiroConfig {
    ...
    public UsernamePasswordRealm passwordRealm(ILocalUserService localUserService, IIdentityService identityService,
    ...
    // 手机号认证
    @Bean
    public PhoneCodeRealm phoneRealm(IShortMsgService codeService, ILocalUserService userService, IIdentityService identityService) {
    ...
    // 基础平台用户认证
    @Bean
    public RemoteSystemRealm remoteSystemRealm(IRemoteUserService remoteUserService, IIdentityService identityService) {
