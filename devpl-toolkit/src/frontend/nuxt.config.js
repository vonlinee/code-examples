...
module.exports = {
    env: {
        ...
        script: [{
            ...
            rel: "stylesheet", href: "//at.alicdn.com/t/font_1617194_0ttjsrqnukiq.css"
        }]
    }, router: {
        ...
        }, base: contextPath, scrollBehavior: function (to, from, savedPosition) {
            return {
                x: 0, y: 0
            };
        }
     ...
     */
    plugins: ["@/plugins/element-ui", "@/plugins/axios", "@/plugins/components"], generate: {
        /*
         ** 指定编译后文件的输出目录
         */
