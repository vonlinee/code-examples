    ...
    <div class="content">
      <div class="container">
        <div style="margin-bottom: 10px">
          <el-select v-model="choosenConnectionName" clearable placeholder="请选择"
          ...
          <el-select v-model="choosenDbName" clearable placeholder="请选择"
                     @change="onDbChange"
                     filterable allow-create default-first-option>
            <el-option
          ...
          <el-select v-model="searchKey" clearable placeholder="请选择数据库表"
                     filterable allow-create default-first-option>
            <el-option
