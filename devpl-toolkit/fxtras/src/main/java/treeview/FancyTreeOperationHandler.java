...
public abstract class FancyTreeOperationHandler<T extends TreeModel> {
    ...
    public boolean handleDelete(ObservableList<TreeItem<T>> selected_items) {
        return false;
    }

    public boolean handleCut(ObservableList<TreeItem<T>> selected_items) {
        return false;
    }

    public boolean handleCopy(ObservableList<TreeItem<T>> selected_items) {
        return false;
    }

    public boolean handlePaste(ObservableList<TreeItem<T>> selected_items) {
        return false;
    }
    ...
    public StartDragInfo startDrag(List<List<Integer>> selection_paths, ObservableList<TreeItem<T>> selected_items) {
        return null;
    }

    public boolean finishDrag(TransferMode transfer_mode, Dragboard dragboard, T item, DropLocation location) {
        return false;
    }
    ...
    public ContextMenu getContextMenu(ObservableList<TreeItem<T>> selected_items) {
        return null;
    }
