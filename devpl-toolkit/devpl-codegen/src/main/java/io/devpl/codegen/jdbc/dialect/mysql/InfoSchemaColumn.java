package io.devpl.codegen.jdbc.dialect.mysql;
...
public class InfoSchemaColumn {
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("InfoSchemaColumn{");
        sb.append("tableCatalog='").append(tableCatalog).append('\'');
        ...
        sb.append(", collationName='").append(collationName).append('\'');
        ...
        sb.append(", generationExpression='").append(generationExpression).append('\'');
        sb.append('}');
        return sb.toString();
    }
}
