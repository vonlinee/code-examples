...
public final class StringUtils {
     ...
     * @see Character#isWhitespace
     */
    private static boolean containsWhitespace(@Nullable CharSequence str) {
        if (!hasLength(str)) {
            return false;
        }
        int strLen = str.length();
    ...
    public static String[] toStringArray(@Nullable Collection<String> collection) {
        return (!org.springframework.util.CollectionUtils.isEmpty(collection) ? collection.toArray(EMPTY_STRING_ARRAY) : EMPTY_STRING_ARRAY);
    }
     ...
     * @return 连字符形式字符串
     */
    public static String camelToHyphen(String src) {
        return src;
    }
