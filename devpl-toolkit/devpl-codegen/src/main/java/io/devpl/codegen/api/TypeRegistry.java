...
public class TypeRegistry {
    ...
    public DataType getColumnType(MetaInfo metaInfo) {
    ...
    private DataType getBitType(MetaInfo metaInfo) {
    ...
    private DataType getNumber(MetaInfo metaInfo) {
    ...
    private DataType getDateType(MetaInfo metaInfo) {
    ...
    private DataType getTimeType(MetaInfo metaInfo) {
        JavaType dbColumnType;
        DateTimeType dateType = globalConfig.getDateType();
    ...
    private DataType getTimestampType(MetaInfo metaInfo) {
        JavaType dbColumnType;
        DateTimeType dateType = globalConfig.getDateType();
        if (dateType == DateTimeType.TIME_PACK) {
