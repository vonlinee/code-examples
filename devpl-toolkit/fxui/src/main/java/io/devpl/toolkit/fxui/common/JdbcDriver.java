...
public enum JdbcDriver {
    ...
    MySQL5("com.mysql.jdbc.Driver", "jdbc:mysql://%s:%s/%s", "mysql-connector-java-5.1.38.jar"),
    MySQL8("com.mysql.cj.jdbc.Driver", "jdbc:mysql://%s:%s/%s", "mysql-connector-java-8.0.11.jar"),
    ...
    JdbcDriver(String driverClass, String connectionUrlPattern, String connectorJarFile) {
        this.driverClass = driverClass;
        this.connectionUrlPattern = connectionUrlPattern;
        this.connectorJarFile = connectorJarFile;
    }

    public static final JdbcDriver DEFAULT_DRIVER = JdbcDriver.MySQL5;
    ...
    public static String[] supportedDbNames() {
        ...
        final JdbcDriver[] drivers = values();
