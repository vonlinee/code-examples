...
public class MessageDialog extends StackPane {
    ...
    private StringProperty yesText = new SimpleStringProperty(TiwulFXUtil.getString("ok"));
    private StringProperty noText = new SimpleStringProperty(TiwulFXUtil.getString("no"));
    private StringProperty cancelText = new SimpleStringProperty(TiwulFXUtil.getString("cancel"));
...
//        setEffect(new DropShadow());
        ...
        switch (dialogType) {
            case CONFIRM:
                ...
                yesText.set(TiwulFXUtil.getString("yes"));
                setTitle(TiwulFXUtil.getString("confirmation"));
                break;
            case ERROR:
                image = TiwulFXUtil.getGraphicFactory().getDialogErrorImage();
                setTitle(TiwulFXUtil.getString("error"));
                break;
            case INFO:
                image = TiwulFXUtil.getGraphicFactory().getDialogInfoImage();
                setTitle(TiwulFXUtil.getString("information"));
                break;
            case WARNING:
                image = TiwulFXUtil.getGraphicFactory().getDialogWarningImage();
                setTitle(TiwulFXUtil.getString("warning"));
                break;
        }
    ...
    private EventHandler<ActionEvent> buttonClickHandler = new EventHandler<>() {
        @Override
