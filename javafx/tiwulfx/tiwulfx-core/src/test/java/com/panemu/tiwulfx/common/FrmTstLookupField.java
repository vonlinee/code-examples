...
public class FrmTstLookupField extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        lkField.setController(new LookupFieldController<Record>(Record.class) {
            ...
            @Override
            protected <C> TableData loadData(int startIndex, List<TableCriteria<C>> filteredColumns, List<String> sortedColumns, List<TableColumn.SortType> sortingTypes, int maxResult) {
