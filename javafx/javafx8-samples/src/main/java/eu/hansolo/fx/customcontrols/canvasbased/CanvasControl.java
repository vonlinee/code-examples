 ...
 public class CanvasControl extends Region {
     ...
     private final ImageParticle[] particles;
     ...
     public String getUserAgentStylesheet() {
         if (null == userAgentStyleSheet) {
             userAgentStyleSheet = CanvasControl.class.getResource("canvas-based.css").toExternalForm();
         }
     ...
     private void resize() {
         ...
         if (width > 0 && height > 0) {
             ...
             for (ImageParticle bubble : particles) {
                 bubble.adjustToSize(width, height);
             }
