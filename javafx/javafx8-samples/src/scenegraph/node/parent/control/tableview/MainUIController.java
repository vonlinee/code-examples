...
public class MainUIController implements Initializable {
	...
	private void loadListViewTestTab() {
		...
		fxmlLoader.setLocation(ResourceLoader.getFxmlResource("ListViewTest.scenegraph.fxml"));
	...
	private void loadTableViewTestTab() {
		FXMLLoader fxmlLoader = new FXMLLoader();
		fxmlLoader.setLocation(ResourceLoader.getFxmlResource("TableViewTest.scenegraph.fxml"));
