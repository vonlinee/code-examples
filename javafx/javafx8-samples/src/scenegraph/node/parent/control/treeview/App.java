...
/**
 * JavaFX TreeView
 * https://stackoverflow.com/questions/31752549/different-behaviour-for-treeitem-javafx
 */
public class App extends Application {

    private final List<Country> countries = Arrays.<Country>asList(new Country("Country 1"), new Country("Country 2"), new Country("Country 3"), new Country("Country 4"), new Country("Country 5"));
