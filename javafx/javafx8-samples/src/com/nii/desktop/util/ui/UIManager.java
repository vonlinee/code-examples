...
public final class UIManager
{
    ...
    public static void switchLoginUI()
    {
        ...
        try
        {
            pane = (Pane) FXMLLoader.load(ResourceLoader.getFxmlResource("LoginUI.scenegraph.fxml"));
        }
        catch (IOException e)
        {
    ...
    public static void switchMainUI()
    {
        ...
        try
        {
            pane = FXMLLoader.load(ResourceLoader.getFxmlResource("Container.scenegraph.fxml"));
        }
        catch (IOException e)
        {
