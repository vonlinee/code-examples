package code.sample.spring.jdbc.template.v2.dao;
...
public class UserDaoImpl {
	...
	public void insertStudent(Student student) {
		...
		SqlParameterSource namedParameters = new MapSqlParameterSource("id", student.getId()).addValue("name",
				student.getName());
		template.update(sql, namedParameters);
		// update() method works fine for insert/delete/update statements. and can also
		// be used with stored procedure.
	}
