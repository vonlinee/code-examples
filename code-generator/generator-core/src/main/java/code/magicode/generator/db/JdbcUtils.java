...
public final class JdbcUtils {
	...
	public static final String MYSQL_URL = "jdbc:mysql://localhost:3306/db_mysql?useUnicode=true&characterEncoding=utf8&useSSL=false&serverTimezone=GMT%2B8";
	...
	public static Optional<Connection> getOptionalConnection() {
		...
		if (result) {
			try {
				connection = DriverManager.getConnection(prop.getProperty("mysql.jdbc.url"),
						prop.getProperty("mysql.jdbc.username"), prop.getProperty("mysql.jdbc.password"));
	...
	public static void getTableMetaData(String dbName, Connection conn) throws Exception {
		...
		String[] tableTypes = {
				"LOCAL TEMPORARY", "SYSTEM TABLE", "SYSTEM VIEW", "TABLE", "VIEW"
		};
