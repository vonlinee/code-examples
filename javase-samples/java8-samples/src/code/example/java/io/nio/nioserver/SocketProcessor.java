...
public class SocketProcessor implements Runnable {
    ...
    // to check for space in the buffer before reading from sockets
    private MessageBuffer readMessageBuffer = null;
    // to check for space in the buffer before reading from sockets (space for more
    // to write?)
    private MessageBuffer writeMessageBuffer = null;
    private IMessageReaderFactory messageReaderFactory = null;
    private Queue<Message> outboundMessageQueue = new LinkedList<>(); // faster queue.
