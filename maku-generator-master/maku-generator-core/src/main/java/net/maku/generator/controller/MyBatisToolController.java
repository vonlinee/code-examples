...
import net.maku.generator.domain.param.GetSqlParam;
import net.maku.generator.enums.MapperStatementParamValueType;
import net.maku.generator.service.MyBatisService;
import net.maku.generator.utils.TypeUtils;
...
@Slf4j
@RestController
@RequestMapping("/maku-generator/api/tools/mybatis")
@AllArgsConstructor
public class MyBatisToolController {
    ...
    public Result<?> getPreCompliedSql(@RequestBody GetSqlParam param) throws Exception {
        ...
        if (param.getReal() == 0) {
            // 预编译sql
            return Result.ok(boundSql.getSql());
        }
