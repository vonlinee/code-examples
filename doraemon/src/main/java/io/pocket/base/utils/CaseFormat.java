...
import static io.pocket.base.lang.Validator.isBlank;
import static io.pocket.base.lang.Validator.notNull;
...
public enum CaseFormat {
    ...
    String convert(CaseFormat format, String s) {
        ...
        return (i == 0) ? format.normalizeFirstWord(s) : requireNonNull(out).append(format.normalizeWord(s.substring(i))).toString();
    }
    ...
    public static String camelize(String tabAttr) {
        if (isBlank(tabAttr)) return tabAttr;
