...
| customMap(Map<String, Object>)                              | 自定义配置 Map 对象  | Collections.singletonMap("tool", "baomidou")                |
| customFile(Map<String, String>)                             | 自定义配置模板文件    | Collections.singletonMap("tool.txt", "/templates/tool.vm")  |
...
new InjectionConfig.Builder()
    ...
    .customMap(Collections.singletonMap("tool", "baomidou"))
    .customFile(Collections.singletonMap("tool.txt", "/templates/tool.vm"))
    .build();
```
