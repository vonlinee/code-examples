 ...
 * @since 2016-12-01
 */
public class MysqlGenerator_csc extends GeneratorTest {
    ...
    public static void main(String[] args) {
        ...
        AutoGenerator mpg = new AutoGenerator().setGlobalConfig(
            // 全局配置
            new GlobalConfig()
                .setOutputDir("D:\\personal_work\\personal_work_code\\personal_work_tool_ly\\MYBATIS_PLUS\\MYBATIS_PLUS_RESULTS\\")//输出目录
            ...
            new DataSourceConfig()
                ...
                .setUrl("jdbc:mysql://172.26.153.165:3306/callcenter?characterEncoding=utf-8&useUnicode=true&useSSL=false")//*需要改
        ).setStrategy(
            // 策略配置
            new StrategyConfig()
                // .setCapitalMode(true)// 全局大写命名
                // .setDbColumnUnderline(true)//全局下划线命名
                .setTablePrefix(new String[]{"t_csc_crm"})// 此处可以修改为您的表前缀
                .setNaming(NamingStrategy.underline_to_camel)// 表名生成策略
                .setInclude(new String[] { 
                		"t_csc_crm_db_source_systemt"
                }) // 需要生成的表
            ...
            new InjectionConfig() {
                ...
                public String outputFile(TableInfo tableInfo) {
                    return "D:\\personal_work\\personal_work_code\\personal_work_tool_ly\\MYBATIS_PLUS\\MYBATIS_PLUS_RESULTS\\RESULTS_XML\\" + tableInfo.getEntityName() + ".xml";
                }
            }))
        ).setTemplate(
