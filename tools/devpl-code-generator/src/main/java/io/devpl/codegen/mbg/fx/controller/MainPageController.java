...
import io.devpl.codegen.mbg.fx.console.ConsoleView;
import io.devpl.codegen.mbg.fx.go.Godrive;
...
//                gf.setIcon(slider, FontAwesomeIcon.TOGGLE_LEFT, "1.5em");
    ...
    public void setEditor(FXEditor edt, Stage stage) {
        this.editor = edt;
        this.stage = stage;
    }
...
//                eng.load(getClass().getResource("/blinderjay_jeditor.html").toString());
                ...
                Timeline larger = new Timeline(
                        new KeyFrame(Duration.millis(666), new KeyValue(splitpane.getDividers().get(0).positionProperty(), 0.7))
