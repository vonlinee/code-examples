...
public class MyBatisPlusCodeGenerator {
    ...
    public static void main(String[] args) {
        FastAutoGenerator.create("jdbc:mysql://192.168.129.30:3306/lgdb_cloud_resource_management?useUnicode=true&characterEncoding=UTF-8&useSSL=false&&serverTimezone=GMT%2B8", "root", "123456")
                         ...
                         .strategyConfig(builder -> {
                             ...
                             builder.addInclude(Arrays.asList("dept")); // 设置需要生成的表名
