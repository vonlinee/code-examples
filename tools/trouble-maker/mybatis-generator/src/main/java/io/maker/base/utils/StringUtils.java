...
public final class StringUtils {
	 ...
	 *             {@link org.apache.commons.lang3.StringUtils#removeEnd(String, String)}
	 *             instead
	 */
	@Deprecated
	 ...
	 */
	static int indexOfCharsequence(final CharSequence cs, final CharSequence searchChar, final int start) {
	...
	public static int countMatches(final CharSequence str, final CharSequence sub) {
		...
		int count = 0;
		int idx = 0;
		while ((idx = indexOfCharsequence(str, sub, idx)) != INDEX_NOT_FOUND) {
			count++;
			idx += sub.length();
		}
		return count;
	 ...
	 * @see org.apache.commons.lang3.StringUtils#endsWith(CharSequence,
	 *      CharSequence)
	 * @since 3.0
	 */
	...
	public static int indexOf(final CharSequence seq, final CharSequence searchSeq) {
		...
		return indexOfCharsequence(seq, searchSeq, 0);
	}
	...
	public static int indexOf(final CharSequence seq, final CharSequence searchSeq, final int startPos) {
		...
		return indexOfCharsequence(seq, searchSeq, startPos);
	}
	...
	public static int indexOf(final CharSequence seq, final int searchChar) {
		...
		return indexOfCharsequence(seq, searchChar, 0);
	}
	...
	public static int indexOf(final CharSequence seq, final int searchChar, final int startPos) {
		...
		return indexOfCharsequence(seq, searchChar, startPos);
	}

	static int indexOfCharsequence(final CharSequence cs, final int searchChar, int start) {
		if (cs instanceof String) {
	...
	public static int indexOfAny(final CharSequence str, final CharSequence... searchStrs) {
		...
		for (final CharSequence search : searchStrs) {
			...
			tmp = indexOfCharsequence(str, search, 0);
	...
	public static int indexOfAnyBut(final CharSequence seq, final CharSequence searchChars) {
		...
		for (int i = 0; i < strLen; i++) {
			...
			final boolean chFound = indexOfCharsequence(searchChars, ch, 0) >= 0;
			if (i + 1 < strLen && Character.isHighSurrogate(ch)) {
				final char ch2 = seq.charAt(i + 1);
				if (chFound && indexOfCharsequence(searchChars, ch2, 0) < 0) {
					return i;
				}
			} else if (!chFound) {
				return i;
	 ...
	 */
	public static int lastIndexOfC(final CharSequence seq, final CharSequence searchSeq, final int startPos) {
		return 1;
	}
	...
	public static int lastIndexOf(final CharSequence seq, final int searchChar) {
		...
		return lastIndexOfCharsequece(seq, searchChar, seq.length());
	}

	static int lastIndexOfCharsequece(final CharSequence cs, final int searchChar, int start) {
		if (cs instanceof String) {
	...
	public static String lowerCase(final String str, final Locale locale) {
		...
		return str.toLowerCase(LocaleUtils.toLocale(locale.toString()));
	}
	...
	private static int ordinalIndexOf(final CharSequence str, final CharSequence searchStr, final int ordinal,
		...
		do {
			if (lastIndex) {
				...
				index = indexOfCharsequence(str, searchStr, index + 1); // step forwards through string
			}
			if (index < 0) {
				return index;
			}
	 ...
	 * @see org.apache.commons.lang3.StringUtils#startsWith(CharSequence,
	 *      CharSequence)
	 * @since 2.5
	 ...
	 * @since 3.1
	 * @deprecated use
	 *             {@link org.apache.commons.lang3.StringUtils#toEncodedString(byte[], Charset)}
	 *             instead of String constants in your code
	 */
	@Deprecated
	public static String toString(final byte[] bytes, final String charsetName) throws UnsupportedEncodingException {
		return new String(bytes, charsetName == null ? Charset.defaultCharset() : Charset.forName(charsetName));
	}
	...
	public static String upperCase(final String str, final Locale locale) {
		...
		return str.toUpperCase(LocaleUtils.toLocale(locale.toString()));
	}
	...
	public static String valueOf(final char[] value) {
		return value == null || value.length == 0 ? NULL_STRING_LCASE : new String(value);
	}
	 ...
	 * 包含任意一个即可
	 **/
	public static boolean containsAlmostOne(String target, String... subStrList) {
		int i = 0;
		for (String subStr : subStrList) {
			if (target.contains(subStr)) {
				i++;
