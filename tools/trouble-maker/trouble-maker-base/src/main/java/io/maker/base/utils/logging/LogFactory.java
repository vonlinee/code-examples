package io.maker.base.utils.logging;
...
public class LogFactory {
    ...
    private LogFactory() {
         ...
         *
         * Pre-load the default file system. No performance impact as we need to load
         * the default file system anyway. Just do it earlier to avoid the potential
         * deadlock.
         *
         * This can be removed once the oldest（更大的） JRE supported by Tomcat includes a
         * fix.
         */
