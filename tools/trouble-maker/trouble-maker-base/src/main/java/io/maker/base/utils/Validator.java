...
public class Validator {
    ...
    public static boolean isNullOrEmpty(File[] directorys) {
        return directorys == null || directorys.length == 0;
    }
    ...
    public static void whenTrue(boolean b, String s, Object... args) {
