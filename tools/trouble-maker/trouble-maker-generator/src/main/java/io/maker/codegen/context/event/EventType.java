...
public final class EventType<T extends ApplicationEvent> implements Serializable {
	
	/**
	 * 
	 */
	private static final long serialVersionUID = -3005629678841102090L;
	
	public static final EventType<ApplicationEvent> ROOT = new EventType<>("EVENT", (EventType) null);
