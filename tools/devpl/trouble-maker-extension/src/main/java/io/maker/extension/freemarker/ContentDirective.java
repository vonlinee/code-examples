...
/**
 * 自定义标签解析类 https://blog.csdn.net/chenghui0317/article/details/7832474
...
public class ContentDirective implements TemplateDirectiveModel {
    ...
    private DefaultObjectWrapperBuilder builder = new DefaultObjectWrapperBuilder(FreeMarker.getVersion());
    ...
    public void execute(Environment env, Map params, TemplateModel[] loopVars, TemplateDirectiveBody body)
        ...
        if (body == null) {
            ...
            if (name != null) {
                env.setVariable("output", builder.build().wrap("从ContentDirective解析类中获得的参数是：" + name + ", "));
            }
            if (age != null) {
                env.setVariable("append", builder.build().wrap("年龄：" + age));
            }
