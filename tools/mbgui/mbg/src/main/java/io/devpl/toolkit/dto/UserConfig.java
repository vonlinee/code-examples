...
public class UserConfig {
    ...
    public OutputFileInfo getControllerInfo() {
        ...
        return outputFiles.stream().filter((f -> Constant.FILE_TYPE_CONTROLLER.equals(f.getFileType()))).findFirst().get();
    }
    ...
    public OutputFileInfo getMapperXmlInfo() {
        ...
        return outputFiles.stream().filter((f -> Constant.FILE_TYPE_MAPPER_XML.equals(f.getFileType()))).findFirst().get();
    }
    ...
    public OutputFileInfo getServiceImplInfo() {
        ...
        return outputFiles.stream().filter((f -> Constant.FILE_TYPE_SERVICEIMPL.equals(f.getFileType()))).findFirst().get();
    }
