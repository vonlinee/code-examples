    ...
    return function (e) {
        ...
        "function" != typeof Object.assign && Object.defineProperty(Object, "assign", {
            ...
            methods: {
                initialize: function () {
                    ...
                    this.merge ? (this.codemirror = i.MergeView(this.$refs.mergeview, t), this.cminstance = this.codemirror.edit) : (this.codemirror = i.fromTextArea(this.$refs.textarea, t), this.cminstance = this.codemirror, this.cminstance.setValue(this.code || this.value || this.content)),
        ...
        var r = function () {
            ...
            return n("div", {
                ...
                ref: "textarea", attrs: {name: e.name, placeholder: e.placeholder}
            })])
