 ...
 */
package io.devpl.codegen.fxui.common.console;
...
public class TextInputControlStream {
    ...
    class TextInputControlInputStream extends InputStream {
        ...
        private final PipedInputStream TextSource;
        private final PipedOutputStream TextTarget;
        ...
        public TextInputControlInputStream(TextInputControl textInputControl) {
            ...
            this.TextTarget = new PipedOutputStream();
            try {
                this.TextSource = new PipedInputStream(this.TextTarget);
        ...
        void enterKeyPressed() {
            synchronized (this) {
                try {
                    ...
                    this.TextTarget.write(buf.array(), 0, buf.remaining());
                    this.TextTarget.flush();
        ...
        public int available() throws IOException {
            return this.TextSource.available();
        }
        ...
        public int read(final byte[] b, final int off, final int len) throws IOException {
            try {
                return this.TextSource.read(b, off, len);
            } catch (IOException ex) {
                return -1;
            }
        }
