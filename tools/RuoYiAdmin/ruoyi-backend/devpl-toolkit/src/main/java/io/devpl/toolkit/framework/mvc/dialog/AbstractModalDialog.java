package io.devpl.toolkit.framework.mvc.dialog;

import java.io.IOException;
import java.net.URL;
import java.util.ResourceBundle;

import io.devpl.toolkit.framework.mvc.AbstractFxmlWindowController;
import io.devpl.toolkit.framework.utils.EditorPlatform;
