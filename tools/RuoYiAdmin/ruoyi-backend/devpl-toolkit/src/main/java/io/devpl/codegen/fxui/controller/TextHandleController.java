...
import io.devpl.codegen.fxui.toolkit.text.TextHandleMap;
import io.devpl.codegen.fxui.utils.StringUtils;
import io.devpl.codegen.fxui.utils.xml.XML;
...
public class TextHandleController extends FXController {
    ...
    private void registerTextHandler() {
        ...
        handleRuleMap.register(btnMavenToGradle, source -> {
            ...
            final Map<String, Object> map = XML.parseXml(source);
        ...
        handleRuleMap.register(btnGradleToMaven, source -> {
            ...
            sb.append("\n\t").append(XML.wrapWithTagName(newCoordinates[0], "groupId"));
            sb.append("\n\t").append(XML.wrapWithTagName(newCoordinates[1], "artifactId"));
            sb.append("\n\t").append(XML.wrapWithTagName(newCoordinates[2], "version"));
            sb.append("\n");
            return XML.wrapWithTagName(sb.toString(), "dependency");
