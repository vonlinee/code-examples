...
import de.saxsys.mvvmfx.ViewLoader;
 ...
 * that you have to call the {@link ViewLoader} by yourself.
 *
 * <br>
 * <p>
...
public class CachedViewModelCellFactory<V extends View<VM>, VM extends ViewModel> implements ViewListCellFactory<VM> {
    ...
    public static <V extends FxmlView<VM>, VM extends ViewModel> CachedViewModelCellFactory<V, VM> createForFxmlView(Class<V> viewType) {
        return create(vm -> ViewLoader.fxmlView(viewType).viewModel(vm).load());
    }
    ...
    public static <V extends JavaView<VM>, VM extends ViewModel> CachedViewModelCellFactory<V, VM> createForJavaView(Class<V> viewType) {
        return create(vm -> ViewLoader.javaView(viewType).viewModel(vm).load());
    }
}
