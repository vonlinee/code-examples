...
public interface ViewModel {
     ...
     * @param messageName of the notification
     * @param payload     to be send
     */
     ...
     * @param messageName of the Notification
     * @param observer    which should execute when the notification occurs
     */
     ...
     * @param messageName of the notification for that the observer should be removed
