...
public class JavaViewLoader {
     ...
     * for this view. <br>
     * If the given view type implements the {@link Initializable}
     ...
     * <strong>public</strong> field of type {@link ResourceBundle}
     ...
     * {@link Initializable} interface or implicit) will be invoked
     ...
     * and the class does not implement the {@link Initializable}
     ...
     * {@link ResourceBundle} named "resources". <br>
     * This method is package scoped for better testability.
     *
     * @param view
