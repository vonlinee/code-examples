...
public abstract class AbstractRoutingDataSource extends AbstractDataSource {
	...
	private DataSourceLookup dataSourceLookup = new DataSourceLookup() {
		@Override
	...
	public void setDataSourceLookup(DataSourceLookup dataSourceLookup) {
		this.dataSourceLookup = (dataSourceLookup != null ? dataSourceLookup : null);
	}
	...
	protected DataSource determineTargetDataSource() {
		if (this.resolvedDataSources == null) {
			throw new IllegalArgumentException("DataSource router not initialized");
		}
