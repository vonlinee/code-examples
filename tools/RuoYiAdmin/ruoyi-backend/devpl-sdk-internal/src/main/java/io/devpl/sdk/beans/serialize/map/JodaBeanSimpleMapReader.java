 ...
 */
package io.devpl.sdk.beans.serialize.map;
...
public class JodaBeanSimpleMapReader {
     ...
     */
    public JodaBeanSimpleMapReader(JodaBeanSerializer settings) {
    ...
    public <T> T read(Map<String, Object> input, Class<T> rootType) {
        BeanUtils.notNull(input, "input");
        BeanUtils.notNull(rootType, "rootType");
        try {
