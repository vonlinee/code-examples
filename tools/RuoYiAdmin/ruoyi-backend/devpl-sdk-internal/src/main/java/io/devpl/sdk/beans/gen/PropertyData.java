...
class PropertyData {
     ...
     * Collection types.
     */
    private static final Set<String> COLLECTIONS = new HashSet<>(Arrays.asList("Collection", "Set", "SortedSet", "NavigableSet", "List", "ArrayList", "LinkedList", "HashSet", "LinkedHashSet", "TreeSet", "ConcurrentSkipListSet, EnumSet", "ImmutableCollection", "ImmutableList", "ImmutableSet", "ImmutableSortedSet"));
    /**
     * Set types.
     */
    private static final Set<String> SETS = new HashSet<>(Arrays.asList("Set", "SortedSet", "NavigableSet", "HashSet", "LinkedHashSet", "TreeSet", "ConcurrentSkipListSet, EnumSet", "ImmutableSet", "ImmutableSortedSet"));
    /**
     * Set types.
     */
    private static final Set<String> SORTED_SETS = new HashSet<>(Arrays.asList("SortedSet", "NavigableSet", "TreeSet", "ConcurrentSkipListSet", "ImmutableSortedSet"));
    /**
     * Map types.
     */
    ...
    public void resolveEqualsHashCodeStyle(File file, int lineIndex) {
        ...
        if (equalsHashCodeStyle.equals("omit") || equalsHashCodeStyle.equals("getter") || equalsHashCodeStyle.equals("field")) {
            return;
        }
        throw new BeanCodeGenException("Invalid equals/hashCode style: " + equalsHashCodeStyle + " in " + getBean().getTypeRaw() + "." + getPropertyName(), file, lineIndex);
    }
    ...
    public void resolveToStringStyle(File file, int lineIndex) {
        ...
        if (toStringStyle.equals("omit") || toStringStyle.equals("getter") || toStringStyle.equals("field")) {
            return;
        }
        throw new BeanCodeGenException("Invalid toString style: " + toStringStyle + " in " + getBean().getTypeRaw() + "." + getPropertyName(), file, lineIndex);
    }
        ...
        if (style.equals("get")) {
            ...
            if (bean.isImmutable()) {
                ...
                if ("clone".equals(clone)) {
                    getterGen = isNotNull() ? GetterGen.CloneNNGetterGen.of(access) : GetterGen.CloneGetterGen.of(access);
                } else if ("cloneCast".equals(clone)) {
                    getterGen = isNotNull() ? GetterGen.CloneCastNNGetterGen.of(access) : GetterGen.CloneCastGetterGen.of(access);
            ...
            throw new BeanCodeGenException("Unable to locate getter generator '" + style + "'" + " in " + getBean().getTypeRaw() + "." + getPropertyName(), file, lineIndex);
        }
    }
    ...
    public void resolveSetterGen(File file, int lineIndex) {
        ...
        if (style.equals("set")) {
            ...
            throw new BeanCodeGenException("Unable to locate setter generator '" + style + "'" + " in " + getBean().getTypeRaw() + "." + getPropertyName(), file, lineIndex);
        }
    }
    ...
    public void resolveCopyGen(File file, int lineIndex) {
        ...
        if (config.getInvalidImmutableTypes().contains(getFieldTypeRaw())) {
            throw new BeanCodeGenException("Invalid collection type for immutable bean: " + getFieldTypeRaw() + " in " + getBean().getTypeRaw() + "." + getPropertyName(), file, lineIndex);
        }
        if (isDerived()) {
    ...
    public boolean isNotNull() {
        return getValidation().equals("notNull") || getValidation().equals("notEmpty") || getValidation().equals("notBlank");
    }
    ...
    public String getValidationMethodName() {
        ...
        if (getValidation().equals("notNull") || getValidation().equals("notEmpty") || getValidation().equals("notBlank")) {
