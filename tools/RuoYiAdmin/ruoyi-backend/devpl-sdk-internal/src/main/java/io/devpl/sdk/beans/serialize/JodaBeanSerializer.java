...
import io.devpl.sdk.beans.serialize.json.JodaBeanJsonReader;
import io.devpl.sdk.beans.serialize.json.JodaBeanJsonWriter;
import io.devpl.sdk.beans.serialize.json.JodaBeanSimpleJsonReader;
import io.devpl.sdk.beans.serialize.json.JodaBeanSimpleJsonWriter;
import io.devpl.sdk.beans.serialize.map.JodaBeanSimpleMapReader;
import io.devpl.sdk.beans.serialize.map.JodaBeanSimpleMapWriter;
import io.devpl.sdk.beans.serialize.xml.JodaBeanXmlReader;
import io.devpl.sdk.beans.serialize.xml.JodaBeanXmlWriter;
 ...
 */
public final class JodaBeanSerializer {

    /**
     * Obtains the singleton compact instance.
     */
    public static final JodaBeanSerializer COMPACT = new JodaBeanSerializer("", "", StringConvert.create(), SerIteratorFactory.INSTANCE, true, SerDeserializers.INSTANCE, false);
    /**
     * Obtains the singleton pretty-printing instance.
     */
    public static final JodaBeanSerializer PRETTY = new JodaBeanSerializer(" ", "\n", StringConvert.create(), SerIteratorFactory.INSTANCE, true, SerDeserializers.INSTANCE, false);
     ...
     */
    private JodaBeanSerializer(String indent, String newLine, StringConvert converter, SerIteratorFactory iteratorFactory, boolean shortTypes, SerDeserializers deserializers, boolean includeDerived) {
        this.indent = indent;
     ...
     */
    public JodaBeanSerializer withIndent(String indent) {
        BeanUtils.notNull(indent, "indent");
        return new JodaBeanSerializer(indent, newLine, converter, iteratorFactory, shortTypes, deserializers, includeDerived);
    }
     ...
     */
    public JodaBeanSerializer withNewLine(String newLine) {
        BeanUtils.notNull(newLine, "newLine");
        return new JodaBeanSerializer(indent, newLine, converter, iteratorFactory, shortTypes, deserializers, includeDerived);
    }
     ...
     */
    public JodaBeanSerializer withConverter(StringConvert converter) {
        BeanUtils.notNull(converter, "converter");
        return new JodaBeanSerializer(indent, newLine, converter, iteratorFactory, shortTypes, deserializers, includeDerived);
    }
     ...
     */
    public JodaBeanSerializer withIteratorFactory(SerIteratorFactory iteratorFactory) {
        BeanUtils.notNull(iteratorFactory, "iteratorFactory");
        return new JodaBeanSerializer(indent, newLine, converter, iteratorFactory, shortTypes, deserializers, includeDerived);
    }
     ...
     */
    public JodaBeanSerializer withShortTypes(boolean shortTypes) {
        return new JodaBeanSerializer(indent, newLine, converter, iteratorFactory, shortTypes, deserializers, includeDerived);
    }
     ...
     * @return a copy of this object with the converter changed, not null
     */
    public JodaBeanSerializer withDeserializers(SerDeserializers deserializers) {
        BeanUtils.notNull(deserializers, "deserializers");
        return new JodaBeanSerializer(indent, newLine, converter, iteratorFactory, shortTypes, deserializers, includeDerived);
    }
     ...
     * @return a copy of this object with the converter changed, not null
     */
    public JodaBeanSerializer withIncludeDerived(boolean includeDerived) {
        return new JodaBeanSerializer(indent, newLine, converter, iteratorFactory, shortTypes, deserializers, includeDerived);
    }
     ...
     * If a bean has subclasses, or the declared type of property or collection is
