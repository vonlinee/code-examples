...
public final class SerTypeMapper {
     ...
     */
    public static String encodeType(Class<?> cls, final JodaBeanSerializer settings, final String basePackage, final Map<Class<?>, String> knownTypes) {
        // basic type
