...
import static io.devpl.sdk.util.Validator.isEmpty;
...
public class FileUtils {
    ...
    private static final Pattern LINUX_PATH_PATTERN = Pattern
            .compile("(/([a-zA-Z0-9][a-zA-Z0-9_\\-]{0,255}/)*([a-zA-Z0-9][a-zA-Z0-9_\\-]{0,255})|/)");

    private static final Pattern WINDOWS_PATH_PATTERN = Pattern
            .compile("(^[A-Z]:((\\\\|/)([a-zA-Z0-9\\-_]){1,255}){1,255}|([A-Z]:(\\\\|/)))");
