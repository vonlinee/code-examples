 ...
 * 基于Map实现一个动态Bean
 */
public class BeanMap extends AbstractDynamicBean implements Map<String, Object>, OptionalTypedGetter<String>, Serializable, Cloneable {
    ...
    public Set<Entry<String, Object>> entrySet() {
        ...
        for (Entry<String, Field<Object>> fieldEntry : entries) {
            entrySet.add(new AbstractMap.SimpleEntry<>(fieldEntry.getKey(), fieldEntry.getValue().getValue()));
        }
        return entrySet;
    }
