...
import com.lancoo.supervisionplatform.service.IShortMsgService;
...
public class PhoneCodeRealm extends AbstractRealm {
    ...
    public PhoneCodeRealm(IShortMsgService codeService, ILocalUserService userService, AuthService identityService) {
