...
import org.mybatis.generator.codegen.mybatis3.xmlmapper.MixedXMLMapperGenerator;
...
public class MixedMapperGenerator extends JavaMapperGenerator {
    ...
    public MixedMapperGenerator(String project) {
        super(project, true);
    }
    ...
    public AbstractXmlGenerator getMatchedXMLGenerator() {
        return new MixedXMLMapperGenerator();
    }
}
