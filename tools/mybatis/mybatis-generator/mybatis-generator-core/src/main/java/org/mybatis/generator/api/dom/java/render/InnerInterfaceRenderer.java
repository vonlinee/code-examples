...
public class InnerInterfaceRenderer {
    ...
    public List<String> render(InnerInterface innerInterface, CompilationUnit compilationUnit) {
        ...
        lines.addAll(DomRender.renderFields(innerInterface.getFields(), compilationUnit));
        lines.addAll(DomRender.renderInterfaceMethods(innerInterface.getMethods(), compilationUnit));
        lines.addAll(DomRender.renderInnerClasses(innerInterface.getInnerClasses(), compilationUnit));
        lines.addAll(DomRender.renderInnerInterfaces(innerInterface.getInnerInterfaces(), compilationUnit));
        lines.addAll(DomRender.renderInnerEnums(innerInterface.getInnerEnums(), compilationUnit));
    ...
    private String renderFirstLine(InnerInterface innerInterface, CompilationUnit compilationUnit) {
        ...
        sb.append(DomRender.renderTypeParameters(innerInterface.getTypeParameters(), compilationUnit));
