...
class MyBatisGeneratorTest {
    ...
    @Test
    void test1() throws XMLParserException, IOException, InvalidConfigurationException, SQLException, InterruptedException {
    ...
    void testGenerateMyBatis3WithInvalidConfig() throws Exception {
        ...
        ConfigurationParser cp = new ConfigurationParser(warnings);
        // 解析配置文件
        Configuration config = cp.parseConfiguration(this.getClass().getClassLoader()
                                                         .getResourceAsStream("generateConfig-mysql5.xml"));
