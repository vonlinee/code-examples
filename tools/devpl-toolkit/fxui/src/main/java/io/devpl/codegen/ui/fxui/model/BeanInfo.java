...
public class BeanInfo {
    ...
    public static void main(String[] args) {
        ...
        beanInfo.setComment("a");
        beanInfo.setFieldName("id");
        beanInfo.setModifier(Modifier.PUBLIC);
        beanInfo.setType("int");
        beanInfo.setInitialValue("name");

        System.out.println(ClassLayout.parseInstance(beanInfo).toPrintable());
    }
}
