...
import io.devpl.logging.LogUtils;
 ...
 * <p>
 * proposed special treatment of array parameter values
 * pointed out double[] omission, suggested deep array copy
 * <p>
...
public final class MessageFormatter {
     ...
     */
    public static FormattedMessage format(String messagePattern, Object arg) {
     ...
     * @return The formatted message
     */
    public static FormattedMessage format(final String messagePattern, Object arg1, Object arg2) {
     ...
     * @return
     */
    public static FormattedMessage arrayFormat(final String messagePattern, final Object[] argArray) {
    ...
    public static String basicArrayFormat(final String messagePattern, final Object[] argArray) {
        FormattedMessage ft = arrayFormat(messagePattern, argArray, null);
     ...
     * @return
     */
    public static FormattedMessage arrayFormat(final String messagePattern, final Object[] argArray, Throwable throwable) {
        if (messagePattern == null) {
            return new FormattedMessage(null, argArray, throwable);
        }
        if (argArray == null) {
            // 参数为null不进行格式化
        ...
        for (L = 0; L < argArray.length; L++) {
            ...
            if (j == -1) {
                ...
                if (i == 0) { // this is a simple string
                    return new FormattedMessage(messagePattern, argArray, throwable);
                } else { // add the tail string which contains no variables and return
                    // the result.
                    sbuf.append(messagePattern, i, messagePattern.length());
                    return new FormattedMessage(sbuf.toString(), argArray, throwable);
                }
            } else {
    ...
    private static void safeObjectAppend(StringBuilder sbuf, Object o) {
        try {
            ...
            LogUtils.report("SLF4J: Failed toString() invocation on an object of type [" + o.getClass().getName() + "]", t);
