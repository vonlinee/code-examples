package com.spawpaw.mbg.plugin;

import com.spawpaw.mbg.util.RegexpUtil;
import com.spawpaw.mbg.util.Utils;
    ...
    public void addFieldComment(Field field,
        ...
        if (generateJPA) {
            ...
            if (introspectedColumn.isIdentity()) {
                introspectedTable.getTableConfiguration().getGeneratedKey().ifPresent(generatedKey -> {
                ...
                Optional<GeneratedKey> generatedKeyOptional = introspectedTable.getTableConfiguration().getGeneratedKey();
                generatedKeyOptional.ifPresent(generatedKey -> field.addAnnotation("@SequenceGenerator(name=\"\",sequenceName=\"" + generatedKey.getRuntimeSqlStatement() + "\")"));
            }
        }
