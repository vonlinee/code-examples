...
//    public SimpleStringProperty savedName = new SimpleStringProperty("untitled");
    @ExportToTab(tabName = Constants.tabs.BASIC_SETTINGS, index = 1)
    @ExportToTab(tabName = Constants.tabs.SHORTCUT, index = 1)
    ...
    @ExportToTab(tabName = Constants.tabs.SHORTCUT, index = 10)
    @ExportToTab(tabName = Constants.tabs.BASIC_SETTINGS, index = 1)
    ...
    /****DAO层配置******************************************************************************************************/
    @ExportToTab(tabName = Constants.tabs.DATA_ACCESS_OBJECT, index = 1)
    ...
    @ExportToTab(tabName = Constants.tabs.SHORTCUT, index = 2)
    @ExportToTab(tabName = Constants.tabs.DATA_ACCESS_OBJECT, index = 1)
    ...
    /****Entity层配置***************************************************************************************************/
    @ExportToTab(tabName = Constants.tabs.DOMAIN_OBJECT, index = 1)
    ...
    @ExportToTab(tabName = Constants.tabs.COMMENT)
    ...
    @ExportToTab(tabName = Constants.tabs.CACHE)
    ...
    @ExportToTab(tabName = Constants.tabs.MVC)
