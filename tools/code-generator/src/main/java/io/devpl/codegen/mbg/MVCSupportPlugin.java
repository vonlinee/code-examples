...
*/
        ...
        servicePreffix = hasLength(servicePreffix) ? servicePreffix : "";
        serviceSuffix = properties.getProperty("serviceSuffix");
        serviceSuffix = hasLength(serviceSuffix) ? serviceSuffix : "";
    ...
    private GeneratedJavaFile generateServiceInterface(IntrospectedTable introspectedTable) {
        ...
        // 添加父接口
        if (hasLength(superServiceInterface)) {
