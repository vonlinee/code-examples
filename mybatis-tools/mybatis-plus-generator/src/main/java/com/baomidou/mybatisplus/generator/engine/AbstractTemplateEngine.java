...
public abstract class AbstractTemplateEngine {
    ...
    public void open() {
        ...
        String ModuleName = getConfigBuilder().getPackageInfo().get("ModuleName");
        String Busicen =getConfigBuilder().getPackageInfo().get("Busicen");
        if(Busicen!=null && ModuleName!=null) {
        	String path = Busicen + StringPool.DOT + ModuleName;
        	outDir = outDir + "\\" + path;
        }
