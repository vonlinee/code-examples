...
public class TableInfo {
    ...
    private String graphql1Name;
    private String graphqlQueryName;
    private String graphqlMutationName;
    private String serviceName;
    private String serviceImplName;
    private String modelName;
    private String controllerName;
    private String excelQueryName;
    private String excelMutationName;
	...
	public void setGraphqlName(String graphqlName) {
		this.graphqlName = graphqlName;
	}
	
	public String getGraphql1Name() {
		return graphql1Name;
	}

	public void setGraphql1Name(String graphql1Name) {
		this.graphql1Name = graphql1Name;
	}
	...
	public void setGraphqlQueryName(String graphqlQueryName) {
		this.graphqlQueryName = graphqlQueryName;
	}
	
	public String getGraphqlMutationName() {
		return graphqlMutationName;
	}

	public void setGraphqlMutationName(String graphqlMutationName) {
		this.graphqlMutationName = graphqlMutationName;
	}
	
	public String getExcelQueryName() {
		return excelQueryName;
	}

	public void setExcelQueryName(String excelQueryName) {
		this.excelQueryName = excelQueryName;
	}
	
	public String getExcelMutationName() {
		return excelMutationName;
	}

	public void setExcelMutationName(String excelMutationName) {
		this.excelMutationName = excelMutationName;
	}
    ...
    public String getComment() {
    	String commentXX = comment.replaceAll("(\r\n|\r|\n|\n\r)", "");
        return commentXX;
        //return comment;
    }
