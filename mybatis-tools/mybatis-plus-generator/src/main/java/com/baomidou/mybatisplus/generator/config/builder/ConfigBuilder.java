...
public class ConfigBuilder {
    ...
    private void handlerPackage(TemplateConfig template, String outputDir, PackageConfig config) {
        ...
        packageInfo.put(ConstVal.BUSICEN, config.getBusicen());
        ...
        if (null != configPathInfo) {
        	...
        	String busicen=this.packageConfig.getBusicen();
        	String parent=this.packageConfig.getParent();
        	parent = parent.replace(".", "\\");
        	//路径段1 busicen.csc\ly.mp.busicen.csc
        	String path1=String.format("%s.%s\\ly.mp.%s.%s", busicen,modelName,busicen,modelName);
            
        	//entities实体类路径段
        	String entityPath2=String.format(".entities\\src\\main\\java\\%s\\entities",parent);
        	pathInfo.put(ConstVal.ENTITY_PATH, outputDir + path1 + entityPath2);

        	//mapper类路径段
        	String mapperPath2=String.format(".idal\\src\\main\\java\\%s\\idal\\mapper",parent);
        	...
        	//GraphqlQuery类路径段
        	String graphqlQueryPath2=String.format(".service\\src\\main\\java\\%s\\resolver\\query",parent);
        	pathInfo.put(ConstVal.GRAPHQL_Query_PATH, outputDir + path1 + graphqlQueryPath2);

        	//GraphqlMutation类路径段
        	String graphqlMutationPath2=String.format(".service\\src\\main\\java\\%s\\resolver\\mutation",parent);
        	pathInfo.put(ConstVal.GRAPHQL_Mutation_PATH, outputDir + path1 + graphqlMutationPath2);

        	//ibiz类路径段
        	String ibizPath2=String.format(".ibiz\\src\\main\\java\\%s\\ibiz",parent);
        	pathInfo.put(ConstVal.SERVICE_PATH, outputDir + path1 + ibizPath2);

        	//biz类路径段
        	String bizPath2=String.format(".biz\\src\\main\\java\\%s\\biz",parent);
        	...
        	//resolverModel类路径段
        	String resolverModelPath2=String.format(".service\\src\\main\\java\\%s\\resolver\\model",parent);
