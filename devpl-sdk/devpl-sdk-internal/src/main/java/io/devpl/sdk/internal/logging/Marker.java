...
public interface Marker extends Serializable {
     ...
     * defined to contain marker B, if A == B or if B is referenced by A, or if B is
     * referenced by any one of A's references (recursively).
    ...
    /**
     * Compute the hash code based on the name of this marker. Note that markers are
