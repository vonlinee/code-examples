 ...
 * EventService} instance.  This class exists solely(仅仅) for simplicity.  Calling
 ...
 * it is just shorter to type.  See {@link EventServiceLocator} for details on how to customize
...
public class EventBus {
    ...
    public static void publish(String topic, Object o) {
        if (topic == null || topic.length() == 0) {
            throw new IllegalArgumentException("Can't publish to null or empty topic.");
        }
    ...
    /**
     * @see EventService#getDefaultCacheSizePerClassOrTopic()
     */
    ...
    /**
     * @see EventService#setCacheSizeForTopic(Pattern, int)
     */
    ...
    /**
     * @see EventService#clearCache(Pattern)
     */
