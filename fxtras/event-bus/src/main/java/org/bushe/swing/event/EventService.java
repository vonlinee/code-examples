 ...
 * as the {@link EventBus}, by providing a class, interface or generic type.  The EventService
 ...
 * {@link PublicationStatus} interface.  EventServices are required to set such objects'
 * {@link PublicationStatus} at the appropriate times during publication.
 * <p/>
...
public interface EventService {
     ...
     * Subscribers will only be notified for publications using  {@link #publish(Type, Object)}.
     * <p>
     ...
     * <p/>
     * The semantics are the same as {@link #subscribe(Pattern, EventTopicSubscriber)}, except that the
