...
public class Chapter4App {
  ...
  public static void main(String[] args) throws IOException {
    ...
    JavaRDD<String> tranFile = sc.textFile("hdfs://192.168.65.130:9000/ch4/ch04_data_transactions.txt");
    ...
    transByCust.map((Tuple2<Integer, String[]> t) -> String.join("#", t._2))
      .saveAsTextFile("hdfs://192.168.65.130:9000/ch4/ch04output-transByCust");
