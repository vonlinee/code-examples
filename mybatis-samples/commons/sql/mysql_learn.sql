...
) ENGINE = InnoDB AUTO_INCREMENT = 10007 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '客户表' ROW_FORMAT = Dynamic;
...
INSERT INTO `customers` VALUES (10006, '张三', '四川省', '成都市', '四川省', NULL, NULL, NULL, NULL);
...
CREATE TABLE `orders`  (
  ...
  `order_date` datetime(6) NOT NULL COMMENT '订单创建日期',
...
) ENGINE = InnoDB AUTO_INCREMENT = 20010 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '订单表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of orders
-- ----------------------------
INSERT INTO `orders` VALUES (10001, '2005-02-28 00:00:00.000000', 10001);
INSERT INTO `orders` VALUES (20005, '2005-09-01 00:00:00.000000', 10001);
INSERT INTO `orders` VALUES (20006, '2005-09-12 00:00:00.000000', 10003);
INSERT INTO `orders` VALUES (20007, '2005-09-30 00:00:00.000000', 10004);
INSERT INTO `orders` VALUES (20008, '2005-10-03 00:00:00.000000', 10005);
INSERT INTO `orders` VALUES (20009, '2005-10-08 00:00:00.000000', 10001);
...
) ENGINE = MyISAM AUTO_INCREMENT = 115 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '产品描述表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `vendors`  (
  `vend_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '供应商ID',
  `vend_name` char(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '供应商名称',
...
) ENGINE = InnoDB AUTO_INCREMENT = 1007 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '生产商表' ROW_FORMAT = Dynamic;
